...
class Application
{
    ...
    public function __construct()
    {
        ...
        if (file_exists('./application/controller/' . $this->url_controller . '.php')) {
            ...
            // Si oui, alors charger ce fichier et créer ce contrôleur
            ...
            // vérifier la méthode: une telle méthode existe-t-elle dans le contrôleur?
    ...
    private function splitUrl()
    {
       // if (isset($_GET['url'])) {
          ...
          //  var_dump($url); exit();
            ...
            $this->url_controller = (isset($url[2]) ? $url[2] : null);
            $this->url_action = (isset($url[3]) ? $url[3] : null);
            $this->url_parameter_1 = (isset($url[4]) ? $url[4] : null);
            $this->url_parameter_2 = (isset($url[5]) ? $url[5] : null);
            $this->url_parameter_3 = (isset($url[6]) ? $url[6] : null);

            // pour le débogage. décommentez ceci si vous avez des problèmes avec l'URL
